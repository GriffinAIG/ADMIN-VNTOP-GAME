...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-center mt-4 font-extrabold text-white">
      ...
      <div className=" h-full flex flex-col duration-300 ease-linear">
        <nav className=" h-full py-4 px-4 lg:mt-9 lg:px-6">
          <div className="my-5 h-full justify-between flex flex-col gap-1.5">
            <div>
              <div>
                <Link
                  href="/"
            ...
            <div className={`group relative flex justify-center items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === "/" && "text-white"
              } `}
            >
              Đăng xuất
            </div>
